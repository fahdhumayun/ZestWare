...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="shifts.php">Employee Shift Table</a>
                </li>
                <li>
                    <a href="absence.php">Absence Reports</a>
                </li>
                <li>
                ...
                <li>
                    <a href="surveyTable.php">Survey Results</a>
                </li>
            </ul>
        </div>
        <!-- /#sidebar-wrapper -->
    ...
    //echo "Welcome {$_SESSION['use']} <br>";
                        $link = mysql_connect("localhost", "root", "marcial");
  ...
  ?>
                        ...
                        <br><br>
                        <input type='button'value='Log Out' class="btn" onclick="document.location.href='../Zestware/logout.php';"/>
                    </div>
                </div>
            </div>
        </div>
